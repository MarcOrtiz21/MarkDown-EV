...
export function SidebarToggleIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
...
export function MoonIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function FolderOpenIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m6 14 1.45-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.7 1.9H18a2 2 0 0 1 2 2v2" />
    </svg>
  )
}
...
export function ListIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function FolderExplorerIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      {...props}
    >
      <path d="M15.5 2H8.6c-.4 0-.8.2-1.1.5L4.5 5.7c-.3.3-.5.7-.5 1.1V20c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-3.5Z" />
      <path d="M4 9h16M9 22v-6M15 22v-6" />
    </svg>
  )
}

export function EmptyIcon({ size = 48, className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
